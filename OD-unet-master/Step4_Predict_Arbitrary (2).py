...
for filename in os.listdir('./Input/')[:]:
    #for filename in filenames:
        ...
        # print('1',test_imgs_orig.size)
        test_imgs_orig = test_imgs_orig.resize([500,500],Image.BILINEAR)
        # test_imgs_orig = test_imgs_orig.convert("RGB")
        # test_imgs_orig.thumbnail((772, 512))
        print('2',test_imgs_orig.size)
        test_imgs_orig = np.asarray(test_imgs_orig)
    ...
    #            predictions[pid,pixel,:]=loc
        ...
        print( "!!!pre_patches  ", pred_patches.shape)
        #if Tensorflow:
        ...
        # pl.imshow(total_img)
        visualize(pred_stripe,"./output_new54/"+filename)#.show()
        time2= time.time()
